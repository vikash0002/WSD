 ...
 * @author Scott White
 */
public class TestBrandesBetweennessCentrality extends TestCase {
    public static Test suite() {
        return new TestSuite(TestBrandesBetweennessCentrality.class);
    }
    ...
    public void testRanker() {
        ...
        BrandesBetweennessCentrality bc = new BrandesBetweennessCentrality(graph);
