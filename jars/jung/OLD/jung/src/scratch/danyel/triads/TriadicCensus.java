...
/**
 * TriadicCensus is a standard social network tool that counts the number
 * of different possible configurations of three vertices in the given graph.
...
//	/**
//	 * The general way of creating a triad count. Counts the triads on the given
//	 * graph
//	 * 
//	 * @param g
//	 *            A directed graph
//	 * @return
//	 */
//	public static TriadicCensus Count(DirectedGraph g) {
//		return new TriadicCensus(g);
//	}

//	protected long[] count = new long[MAX_TRIADS];
...
//	protected Indexer id;
	 ...
	 * @param g
	 */
//	protected TriadicCensus(DirectedGraph g) {
    public static long[] getCounts(DirectedGraph g)
    {
        long[] count = new long[MAX_TRIADS];

		// counts should be zero'd
//		initializeCounts();
		// now let's count triads!

		// for any selection of vertices, ensure they are in order
//		Indexer id = Indexer.getIndexer(g, this);
	 ...
	 */
	static final int[] codeToType = { 1, 2, 2, 3, 2, 4, 6, 8, 2, 6, 5, 7, 3, 8,
